    ...
    <header className="relative min-h-screen py-16 md:py-24 lg:py-32 flex items-center justify-center">
      <div className="relative container text-center">
        <div className="relative inline-flex items-center gap-2 mb-8">
          <div className="absolute -inset-1 bg-gradient-to-r from-primary/30 to-accent/30 rounded-full blur opacity-20 animate-pulse"></div>
          <div className="relative inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 backdrop-blur-sm">
            <div className="relative w-4 h-4 text-primary">
              <div className="absolute inset-0 text-primary/30 blur-sm animate-pulse">
